namespace Solnet.JupiterSwap.Types
{
    /// <summary>
    ...
    public class Percentage
    {
            ...
            try
            {
                checked
                {
                    ...
                    else
                    {
                        ...
                        frac = new Percentage((int)Math.Round(dTemp), iMultiple);
                    }
                    return frac;
                }
            }
        ...
        { return Add(frac1, FromDouble(dbl)); }
        ...
        public static Percentage operator *(double dbl, Percentage frac1)
        { return Multiply(frac1, FromDouble(dbl)); }
        ...
        public static Percentage operator /(double dbl, Percentage frac1)
        { return Multiply(Inverse(frac1), FromDouble(dbl)); }

        public static Percentage operator /(Percentage frac1, double dbl)
        { return Multiply(frac1, Inverse(FromDouble(dbl))); }
